...
// SessionProvider is mounted once at the root (RootSessionProvider), so we
// don't re-wrap here — that previously caused nested providers and redundant
// session fetches on every /admin/* render.
