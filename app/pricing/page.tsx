...
const tiers = [
  ...
  { name: 'Enterprise', price: '$2k+', sub: 'platform fee + commit · annual', cta: 'contact', href: 'mailto:hi@goku.codes?subject=panel%20enterprise', features: ['≥ 5M verifies baseline · $0.0010 overage', 'unlimited retention · queryable api', 'signed DPA, SCC, BAA on request', 'private scrubber rule packs', 'dedicated slack, 4h response, 99.9% uptime + named CSM', 'US/EU/regional dedicated stack', 'react/svelte widget source'] },
];
